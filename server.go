...
func main() {
	...
	r.HandleFunc("GET", "/", router.Redirect("/calendar_month"))
	...
	r.HandleFunc("GET", "/calendar_month", calendar.MonthDefaultController)
	r.HandleFunc("GET", "/calendar_month/:year/:month", calendar.MonthController)
